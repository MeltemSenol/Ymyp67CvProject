    ...
    public class SkillManager : ISkillService
    {
        ...
        public async Task<IDataResult<SkillResponseDto>> AddAsync(SkillCreateRequestDto dto)
        {
            try
            {
                ...
                return new SuccessDataResult<SkillResponseDto>(_mapper.Map<SkillResponseDto>(skill), ResultMessages.SuccessCreated);
            }
            catch (Exception e)
            {
        ...
        public async Task<IDataResult<IEnumerable<SkillResponseDto>>> GetAllAsync()
        {
            try
            {
                ...
                return new SuccessDataResult<IEnumerable<SkillResponseDto>>(dtos, ResultMessages.SuccessListed);
            }
        ...
        public async Task<IDataResult<IEnumerable<SkillResponseDto>>> GetSkillsProgramLanguageAsync()
        {
            try
            {
